...
// const OPERATOR_ID = '0.0.2336';
// const OPERATOR_KEY = '302e020100300506032b6570042204202cc589a6343ff8d05b71edf54f69bff4cd8faeec9b04d16f55d1d78fe23841af';
async function main() {
  // if (OPERATOR_ID == null || OPERATOR_KEY == null) {
  //     throw new Error(
  ...
  const privateKey = PrivateKey.fromString("bf988c03f204d6fa83a8b101c2d85fc7222b790547c80115b43a6a2ade5144a9");
  const publicKey = '0268462367cde34bb7012f7b89b585879fea66d0e665e28982bba364530c36dc5a';

  // Assuming that the target shard and realm are known.
  // For now they are virtually always 0 and 0.
  const aliasAccountId = AccountId.fromString('0.0.49100228');
  ...
  AccountId.fromString(
      "0.0.0268462367cde34bb7012f7b89b585879fea66d0e665e28982bba364530c36dc5a"
  );

  PublicKey.fromString(
      "0268462367cde34bb7012f7b89b585879fea66d0e665e28982bba364530c36dc5a"
  ).toAccountId(0, 0);
